...
namespace abc
{
	...
	void Swapchain::Destroy()
	{
		...
		vkDestroySwapchainKHR(m_renderer->GetDevice()->GetLogical(), m_swapchain, nullptr);
	}
	...
	{
		SwapChainSupportDetails swapChainSupport = m_renderer->QuerySwapChainSupport(m_renderer->GetDevice()->GetPhysical());
		...
		QueueFamilyIndices indices = m_renderer->FindQueueFamilies(m_renderer->GetDevice()->GetPhysical());
		...
		if (vkCreateSwapchainKHR(m_renderer->GetDevice()->GetLogical(), &createInfo, NULL, &m_swapchain) != VK_SUCCESS)
		{
